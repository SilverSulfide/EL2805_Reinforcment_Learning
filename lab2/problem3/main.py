...
for i in EPISODES:
    ...
    if avg_reward > 130 and avg_reward > best_loss:
        best_loss = avg_reward
        torch.save(PPO.critic_network.state_dict(), 'critic_checkpoint_big.pth')
        torch.save(PPO.actor_network.state_dict(), 'actor_checkpoint_big.pth')
